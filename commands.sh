...
tzc transfer 10.0 from bob to potato-game-v1 --entrypoint "buy_ticket_for_game" \
    --arg "\"<potato-wallet-bob-v1>%receive\"" --burn-cap 1

tzc transfer 0 from alice to potato-game-v1 --entrypoint "start_game" --burn-cap 1
